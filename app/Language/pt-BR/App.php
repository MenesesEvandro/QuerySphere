...
return [
    ...
    'schema_editor' => [
        ...
        'table_drop_successfully' => 'A tabela {0} foi excluída com sucesso',
        ...
        'index_name_placeholder' => 'ex: idx_nome_coluna',
        'confirm_drop_index' => 'Tem a certeza de que deseja excluir o índice {0}?',
        'index_dropped_successfully' => 'Índice {0} excluído com sucesso.',
        'index_created_successfully' => 'Índice {0} criado com sucesso.',
        'index_creation_failed' => 'A criação do índice falhou.',
        'index_drop_failed' => 'A exclusão do índice falhou.',
        'select_columns' => 'Selecione as colunas',
        'constraints' => 'Constraints',
        'foreign_keys' => 'Chaves Estrangeiras',
        'add_foreign_key' => 'Adicionar Chave Estrangeira',
        'fk_name' => 'Nome da Constraint',
        'fk_name_placeholder' => 'ex: fk_tabela_tabela_ref',
        'fk_columns' => 'Colunas Nesta Tabela',
        'fk_references_table' => 'Tabela de Referência',
        'fk_references_columns' => 'Colunas na Tabela de Referência',
        'confirm_drop_fk' => 'Tem a certeza de que deseja excluir a chave estrangeira {0}?',
        'fk_dropped_successfully' => 'Chave estrangeira {0} excluída com sucesso.',
        'fk_created_successfully' => 'Chave estrangeira {0} criada com sucesso.',
        'fk_creation_failed' => 'A criação da chave estrangeira falhou.',
        'fk_drop_failed' => 'A exclusão da chave estrangeira falhou.',
    ],
            ...
            '60_security' => [
                ...
                'scripts' => [
                    ...
                    '40_audit_server_level_permissions.sql' => [
                        'title' =>
                            'Auditoria de Permissões Elevadas (Servidor)',
                        'description' =>
            ...
            '10_performance' => [
                ...
                'scripts' => [
                    '10_active_processes.sql' => [
                        'title' => 'Monitorar Processos Ativos',
                        'description' =>
                            'Mostra todos os processos ativos e consultas no servidor MySQL.',
                    ],
                    '20_slowest_queries_history.sql' => [
                        'title' => 'Top 10 Consultas Mais Lentas (Histórico)',
                        'description' =>
                            'Analisa o Performance Schema para encontrar as consultas mais lentas.',
                    ],
                ],
            ],
            '20_space_usage' => [
                ...
                'scripts' => [
                    '10_largest_tables.sql' => [
                        'title' => 'Listar Tabelas Maiores',
                        'description' =>
                            'Lista as maiores tabelas no banco de dados atual por tamanho.',
                    ],
                ],
            ],
            '30_indexes' => [
                ...
                'scripts' => [
                    '10_index_usage.sql' => [
                        'title' => 'Analisar Uso de Índices',
                        'description' =>
                            'Mostra as estatísticas de leitura para cada índice, ajudando a identificar os que não são utilizados.',
                    ],
                    '20_duplicate_indexes.sql' => [
                        'title' => 'Encontrar Índices Duplicados',
                        'description' =>
                            'Lista quaisquer índices que sejam duplicados ou redundantes e que possam ser candidatos a remoção.',
                    ],
                ],
            ],
            '60_security' => [
                ...
                'scripts' => [
                    '10_users_with_all_privileges.sql' => [
                        'title' =>
                            'Listar Utilizadores com Privilégios Elevados',
                        'description' =>
                            'Auditoria de segurança que lista todos os utilizadores com privilégios de SUPER ou GRANT.',
                    ],
                ],
            ],
        ],
