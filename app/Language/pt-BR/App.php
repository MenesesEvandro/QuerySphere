...
return [
    ...
    'execution_plan_generation_failed' => 'Falha na geração do plano de execução.',
    ...
    'sqlsrv_extension_note' => 'Crítico: Essencial para conectar ao SQL Server.',
    'intl_extension_note'   => 'Crítico: Requerido pelo CodeIgniter 4 para internacionalização.',
    'mbstring_extension_note' => 'Crítico: Essencial para manipulação de strings multibyte.',
    'json_extension_note'   => 'Crítico: Essencial para as respostas da API.',
    'xml_extension_note'    => 'Importante: Necessário para a funcionalidade de "Plano de Execução".',
    'enabled' => 'Habilitada',
    'not_found' => 'Não encontrada',
    'writable_permission' => 'Permissão de escrita na pasta "writable"',
    'writable_permission_note' => 'O CodeIgniter precisa de permissão para escrever logs, cache e sessões.',
    'env_file' => 'Arquivo de ambiente ".env"',
    'env_file_note' => 'Recomendado para configurar o ambiente de produção/desenvolvimento.',
    ...
    'error_loading_definition' => 'ERRO: Não foi possível carregar a definição do objeto.',
    ...
    'confirm_delete_shared' => 'Tem certeza que deseja apagar esta query compartilhada para todos?',
    ...
    'check_ok_message' => 'Seu servidor atende a todos os requisitos críticos para executar a aplicação.',
    'check_warn_title' => 'Atenção!',
    'check_warn_message' => 'Seu servidor possui alguns avisos, mas os requisitos críticos foram atendidos. A aplicação deve funcionar, mas verifique os pontos abaixo.',
    'check_fail_title' => 'Problemas Encontrados!',
    'check_fail_message' => 'Seu servidor não atende a um ou mais requisitos críticos. A aplicação não funcionará corretamente até que os itens marcados com FALHA sejam corrigidos.',
    ...
    'check_php_version_note' => 'A versão mínima recomendada para o projeto é 8.0.',
    'check_item_extension' => 'Extensão PHP: {0}',
    'check_note_sqlsrv' => 'Crítico: Essencial para conectar ao SQL Server.',
    'check_note_intl' => 'Crítico: Requerido pelo CodeIgniter 4 para internacionalização.',
    'check_note_mbstring' => 'Crítico: Essencial para manipulação de strings multibyte.',
    'check_note_json' => 'Crítico: Essencial para as respostas da API.',
    'check_note_xml' => 'Importante: Necessário para a funcionalidade de Plano de Execução.',
    ...
    'check_writable_note' => 'O CodeIgniter precisa de permissão para escrever logs, cache e sessões.',
    'check_env_file' => 'Arquivo de ambiente ".env"',
    'check_found' => 'Encontrado',
    'check_env_file_note' => 'Recomendado para configurar o ambiente de produção/desenvolvimento.',
