...
return [
    ...
    'general' => [
        ...
        'session_expired_title' => 'Session About to Expire',
        'session_expired_message' => 'Your session will be terminated due to inactivity.',
        'session_countdown_message' => 'You will be disconnected in {0} seconds.',
        'session_stay_connected' => 'Stay Connected',
        'session_logged_out_inactivity' => 'Disconnected due to inactivity.',
    ],
            ...
            '20_space_usage' => [
                ...
                'scripts' => [
                    '10_largest_tables.sql' => [
                        ...
                        'description' =>
                            'Calculates and lists the tables in the current database, ordered by total space.',
                    ],
            ...
            '30_indexes' => [
                ...
                'scripts' => [
                    ...
                    '20_unused_indexes.sql' => [
                        ...
                        'description' =>
                            'Finds indexes that are maintained (updated) but rarely or never used in reads.',
                    ],
            ...
            '40_current_activity' => [
                ...
                'scripts' => [
                    ...
                    '20_active_connections.sql' => [
                        ...
                        'description' =>
                            'Lists all active connections on the server, showing user, machine, and program.',
                    ],
                ],
            ],
            ...
            '60_security' => [
                ...
                'scripts' => [
                    ...
                    '30_audit_high_level_permissions.sql' => [
                        ...
                        'description' =>
                            'Checks users with critical permissions (CONTROL, IMPERSONATE) in the current database.',
                    ],
                    '40_audit_server_level_permissions.sql' => [
                        'title' => 'Audit High-Level Permissions (Server)',
                        'description' =>
                            'Checks logins with critical permissions (CONTROL SERVER) at the server level.',
                    ],
                ],
            ],
            '70_sql_server_agent' => [
                ...
                'scripts' => [
                    '10_failed_jobs_last_24h.sql' => [
                        ...
                        'description' =>
                            'Lists all SQL Server Agent jobs that failed in the last 24 hours.',
                    ],
            ...
            '80_object_management' => [
                ...
                'scripts' => [
                    '10_check_object_dependencies.sql' => [
                        ...
                        'description' =>
                            'Use this script to see which other objects depend on a table or procedure before modifying it.',
                    ],
                ],
            ],
        ],
